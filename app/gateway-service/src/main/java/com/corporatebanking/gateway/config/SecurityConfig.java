...
public class SecurityConfig {
    ...
    public SecurityFilterChain publicFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .securityMatcher("/auth/login", "/api/v1/transaction", "/api/v1/transaction/", "/api/v1/transaction/**")
                .addFilterBefore(requestLoggingFilter, AuthorizationFilter.class)
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers(HttpMethod.POST, "/api/v1/transaction", "/api/v1/transaction/**").permitAll()
